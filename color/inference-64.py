...
if __name__ == '__main__':
    ...
    trained_model = trained_model_module.load_from_checkpoint(checkpoint_path="/home/data/vae_best_models/batch128_latent64/epoch=99-step=7400.ckpt", latent_dim=args.latent_dim) # this files location can be changed later
