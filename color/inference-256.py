...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(max_epochs=args.epochs, replace_sampler_ddp=rddp,accelerator="gpu",devices=2,logger=tb_logger,num_nodes=args.nodes,auto_lr_find=False,benchmark=True,fast_dev_run=False) #flush_logs_every_n_steps=1
    ...
    trained_model = trained_model_module.load_from_checkpoint(checkpoint_path="/home/data/vae_best_models/batch128_latent256/epoch=99-step=7400.ckpt", latent_dim=args.latent_dim) # this files location can be changed later
